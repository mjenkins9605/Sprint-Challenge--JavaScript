...
*/
const largerPopulation = []; // <---- shouldn't we call this lowerPopulation? Very misleading
...
const popTotal = zooAnimals.reduce(function (accumulator, currentValue) {
  return {population: accumulator.population + currentValue.population};
})
populationTotal.push(popTotal);
